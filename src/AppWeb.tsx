/**
 * Web App with Supabase backend and end-to-end encryption:
...
export function AppWeb({ userId, userEmail, encryptionKey, accessToken, onSignOut }: AppWebProps) {
  const encryptionReady = Boolean(userId && encryptionKey);

  // Use Supabase with encryption
        ...
        <div className="flex-1 glass flex flex-col overflow-hidden">
          ...
          {activePanel === "account" ? (
            <div className="p-6 space-y-4 overflow-y-auto custom-scrollbar">
              ...
              <div className="rounded-md border border-gray-200 dark-amoled:border-gray-800 p-4 glass space-y-4">
                <div>
                  <div className="text-sm font-medium text-gray-700 dark-amoled:text-gray-300">Email</div>
                  <div className="mt-1 p-2 bg-gray-50 dark-amoled:bg-gray-900 rounded font-medium break-all">
                    {userEmail || "Not available"}
                  </div>
                </div>
                <div>
                  <div className="text-sm font-medium text-gray-700 dark-amoled:text-gray-300">User ID</div>
                  <div className="mt-1 p-2 bg-gray-50 dark-amoled:bg-gray-900 rounded font-mono text-xs break-all">
                    {userId}
                  </div>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <Button 
                  onClick={onSignOut} 
                  variant="outline" 
                  className="w-full justify-start text-red-600 border-red-200 hover:bg-red-50 dark-amoled:border-red-900 dark-amoled:hover:bg-red-900/20"
                >
            ...
            <div className="p-6 space-y-4 overflow-y-auto custom-scrollbar">
              <h2 className="text-xl font-semibold">Security & Encryption</h2>
              
              <div className="p-4 bg-green-50 dark-amoled:bg-green-900/20 border border-green-200 dark-amoled:border-green-800 rounded-lg">
                <div className="flex items-start gap-3">
                  <Shield className="h-5 w-5 text-green-600 dark-amoled:text-green-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-medium text-green-800 dark-amoled:text-green-300">End-to-End Encryption Active</div>
                    <div className="text-sm text-green-700 dark-amoled:text-green-400 mt-1">
                      Your notes are encrypted with zero-knowledge encryption. Only you can decrypt them with your passphrase.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-md border border-gray-200 dark-amoled:border-gray-800 p-4 glass">
                <div className="text-sm font-medium mb-3">Encryption Status</div>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-3 bg-gray-50 dark-amoled:bg-gray-900 rounded-md">
                    <span className="text-sm">Master Key</span>
                    <span className="text-xs text-green-600 dark-amoled:text-green-400 font-medium">✓ Active</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 dark-amoled:bg-gray-900 rounded-md">
                    <span className="text-sm">Database Encryption</span>
                    <span className="text-xs text-green-600 dark-amoled:text-green-400 font-medium">✓ Enabled</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 dark-amoled:bg-gray-900 rounded-md">
                    <span className="text-sm">Cloud Sync</span>
                    <span className="text-xs text-green-600 dark-amoled:text-green-400 font-medium">✓ Connected</span>
                  </div>
                </div>
              </div>

              <div className="p-4 bg-blue-50 dark-amoled:bg-blue-900/20 border border-blue-200 dark-amoled:border-blue-800 rounded-lg">
                <div className="text-sm text-blue-800 dark-amoled:text-blue-300">
                  <strong>Important:</strong> Your passphrase is never sent to our servers. 
                  All encryption happens in your browser. If you lose your passphrase, your notes cannot be recovered.
                </div>
              </div>
            </div>
          ) : selectedNoteFull ? (
